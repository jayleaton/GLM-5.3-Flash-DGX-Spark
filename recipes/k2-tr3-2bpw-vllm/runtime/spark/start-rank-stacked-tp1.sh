...
IMAGE="${GLM53_IMAGE:-local/glm53-flash-exl3-k2-rankstacked-tp1:pinned-candidate}"
...
exec docker run --rm \
  ...
  --compilation-config '{"cudagraph_mode":"FULL_DECODE_ONLY","custom_ops":["all"],"cudagraph_capture_sizes":[1],"max_cudagraph_capture_size":1}' \
